/**
 * \file      udp_manager.h
 * \brief     Header file for communication with UDP socket.
...
namespace comm {
  ...
  namespace network {
    ...
    /**
     * \class udp_channel
     * \brief This class implements UDP socket networking
     *
     * \see abstract_channel
     */
    class udp_channel : public abstract_channel {
    ...
    public:
       ...
       * \see socket_address
       */
      udp_channel(const socket_address & p_host_address);
      /**
       ...
       * \see socket_address
       */
      udp_channel(const socket_address & p_host_address, const socket_address & p_remote_address);
      /**
