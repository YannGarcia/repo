...
/*!
 * \brief Test case for \sa ipc::shared_memory
 */
...
/*!
 * \brief Test case for \sa ipc::message_queue
 */
...
/*!
 * \brief Test case for \sa ipc::ipc_manager
...
/*!
 * \brief Test case for \sa ipc::ipc_manager/share_memory
 * Check ipc::ipc_manager::create_ipc, ::ipc::ipc_managerget_ipc and ipc::ipc_manager::remove_ipc
 */
...
/*!
 * \brief Test case for \sa ipc::ipc_manager/message_queue
 * Check ipc::ipc_manager::create_ipc, ::ipc::ipc_managerget_ipc and ipc::ipc_manager::remove_ipc
 */
