/**
 * @file    libhal_i2c.h
 * @brief   Main header file for the I2C Hardware Abstract Layer library.
 ...
 */
#if !defined(__BEAGLEBONEBLACK_I2C_H__)
#define __BEAGLEBONEBLACK_I2C_H__
...
#endif // __BEAGLEBONEBLACK_I2C_H__
