...
namespace getOpt
{
  ...
  public:
    GETOPT_INLINE getOpt(int argc, const char* const* const argv);
    GETOPT_INLINE getOpt(int argc, const char* const* const argv, _EnvTag);
    ...
    GETOPT_INLINE getOpt& operator >> (const _Option& opt) throw(getOptEx);

    GETOPT_INLINE getOpt& operator >> (std::ios_base& (*iomanip)(std::ios_base&));
	...
	return data.short_iter;
      ...
      template <class T>
      static void extract(T& t, getOpt& getopt_pp, char option)
      {
	...
	return data.long_iter;
      ...
      template <class T>
      static void extract(T& t, getOpt& getopt_pp, const std::string& option)
      {
...
using namespace beagleboneUtils::getOpt;
