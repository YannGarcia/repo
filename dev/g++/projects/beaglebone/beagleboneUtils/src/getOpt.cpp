/*
  getOtp: Yet another C++ version of getopt.
  This file is part of getOtp.
  ...
  getOtp IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR
...
namespace getOpt
{
  ...
  GETOPT_INLINE Token* getOpt::_add_token(const std::string& value, Token::Type type)
  {
  ...
  GETOPT_INLINE void getOpt::_init_flags()
  {
    std::stringstream ss;
    _flags = ss.flags();
  }

  GETOPT_INLINE void getOpt::_parse_sub_file(const std::string& file)
  {
  ...
  GETOPT_INLINE void getOpt::_parse(const std::vector<std::string>& args)
  {
  ...
  GETOPT_INLINE void getOpt::_parse_env()
  {
  ...
  GETOPT_INLINE void getOpt::_argc_argv_to_vector(int argc, const char* const* const argv, std::vector<std::string>& args)
  {
    for (int i = 0; i < argc; i++)
      args.push_back(argv[i]);
  }

  GETOPT_INLINE getOpt::TokensDeleter::~TokensDeleter()
  {
    Token* next;
  ...
  GETOPT_INLINE getOpt::getOpt(int argc, const char* const* const argv)
  ...
  GETOPT_INLINE getOpt::getOpt(int argc, const char* const* const argv, _EnvTag)
  ...
  GETOPT_INLINE getOpt& getOpt::operator >> (const _Option& opt) throw(getOptEx)
  {
  ...
  GETOPT_INLINE getOpt& getOpt::operator >> (std::ios_base & (*iomanip)(std::ios_base&))
  {
    std::stringstream ss;
    ss.flags(_flags);
  ...
  GETOPT_INLINE bool getOpt::options_remain() const
  {
    bool remain = false;
